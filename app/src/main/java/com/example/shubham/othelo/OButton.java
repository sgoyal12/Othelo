...
public class OButton extends android.support.v7.widget.AppCompatButton {
   ...
   public OButton(Context context) {
    ...
    private void perform(OButton board[][],int size) {
       ...
       dir=this.check(board,size,currentPlayer);
 ...
 public int[] check(OButton board[][],int size,int currentPlayer){
     int otherPlayer,a,i,j;
     i=this.x;
     j=this.y;
    ...
    public void checkValidStatus(int currentPlayer, OButton[][] board, int size) {
        for(int i=0;i<size;i++)
        {
            ...
            {
              int status,otherPlayer,a,dir[]=new int[size];
    ...
    public void setValidStatus( OButton[][] board, int size) {
     int a=0;
     for(int i=0;i<size;i++)
        {
            for(int j=0;j<size;j++)
            ...
            MainActivity.validprevious=MainActivity.validMove;
            MainActivity.validMove=a;
